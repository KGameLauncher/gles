...
interface glCompressedTexImage2D {
    ...
    */
    fun glCompressedTexImage2D(target: Int, level: Int, internalformat: Int, width: UInt, height: UInt, border: Int, imageSize: UInt, data: de.dasbabypixel.gamelauncher.buffers.BufferRO)
}