...
interface glVertexAttribPointer {
    /**
    * Name
    * ----
    * 
    ...
    */
    fun glVertexAttribPointer(index: UInt, size: Int, type: Int, normalized: Boolean, stride: UInt, pointer: de.dasbabypixel.gamelauncher.buffers.BufferRO)
}