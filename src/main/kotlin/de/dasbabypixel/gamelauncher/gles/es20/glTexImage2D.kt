...
interface glTexImage2D {
    ...
    */
    fun glTexImage2D(target: Int, level: Int, internalFormat: Int, width: UInt, height: UInt, border: Int, format: Int, type: Int, data: de.dasbabypixel.gamelauncher.buffers.BufferRO)
}