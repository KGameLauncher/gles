...
interface glProgramUniformMatrix3fv {
    /**
    * Name
    * ----
    * 
    ...
    */
    fun glProgramUniformMatrix3fv(program: UInt, location: Int, count: UInt, transpose: Boolean, value: de.dasbabypixel.gamelauncher.buffers.FloatBufferRO)
}