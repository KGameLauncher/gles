...
interface glProgramUniformMatrix2fv {
    /**
    * Name
    * ----
    * 
    ...
    */
    fun glProgramUniformMatrix2fv(program: UInt, location: Int, count: UInt, transpose: Boolean, value: de.dasbabypixel.gamelauncher.buffers.FloatBufferRO)
}