...
interface glProgramUniformMatrix4x3fv {
    /**
    * Name
    * ----
    * 
    ...
    */
    fun glProgramUniformMatrix4x3fv(program: UInt, location: Int, count: UInt, transpose: Boolean, value: de.dasbabypixel.gamelauncher.buffers.FloatBufferRO)
}