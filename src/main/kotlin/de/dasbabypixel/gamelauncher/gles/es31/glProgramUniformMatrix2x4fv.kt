...
interface glProgramUniformMatrix2x4fv {
    /**
    * Name
    * ----
    * 
    ...
    */
    fun glProgramUniformMatrix2x4fv(program: UInt, location: Int, count: UInt, transpose: Boolean, value: de.dasbabypixel.gamelauncher.buffers.FloatBufferRO)
}