...
interface glProgramUniformMatrix3x4fv {
    /**
    * Name
    * ----
    * 
    ...
    */
    fun glProgramUniformMatrix3x4fv(program: UInt, location: Int, count: UInt, transpose: Boolean, value: de.dasbabypixel.gamelauncher.buffers.FloatBufferRO)
}