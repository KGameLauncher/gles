...
interface glProgramUniformMatrix2x3fv {
    /**
    * Name
    * ----
    * 
    ...
    */
    fun glProgramUniformMatrix2x3fv(program: UInt, location: Int, count: UInt, transpose: Boolean, value: de.dasbabypixel.gamelauncher.buffers.FloatBufferRO)
}