...
interface glBlendFuncSeparatei {
    /**
    * Name
    * ----
    * 
    ...
    * -----------
    * 
    * Pixels can be drawn using a function that blends the incoming (source) RGBA values with the RGBA values that are already in the frame buffer (the destination values). Blending is initially disabled. Use [glEnable][de.dasbabypixel.gamelauncher.gles.es20.glEnable.glEnable] and [glDisable][de.dasbabypixel.gamelauncher.gles.es20.glEnable.glEnable] with argument `GL_BLEND` to enable and disable blending.
    * 
    * `glBlendFuncSeparate` defines the operation of blending for all draw buffers when it is enabled. `glBlendFuncSeparatei` defines the operation of blending for a single draw buffer specified by _`buf`_ when enabled for that draw buffer. _`srcRGB`_ specifies which method is used to scale the source RGB-color components. _`dstRGB`_ specifies which method is used to scale the destination RGB-color components. Likewise, _`srcAlpha`_ specifies which method is used to scale the source alpha color component, and _`dstAlpha`_ specifies which method is used to scale the destination alpha component. The possible methods are described in the following table. Each method defines four scale factors, one each for red, green, blue, and alpha.
    * 
    * In the table and in subsequent equations, source and destination color components are referred to as R s G s B s A s , and R d G d B d A d , respectively. The color specified by [glBlendColor][de.dasbabypixel.gamelauncher.gles.es20.glBlendColor.glBlendColor] is referred to as R c G c B c A c .
    * 
    ...
    * | `GL_ONE_MINUS_SRC_COLOR` | 1 1 1 \- R s k R G s k G B s k B | 1 \- A s k A |
    ...
    * ------
    * 
    * `GL_INVALID_ENUM` is generated if either _`srcRGB`_ or _`dstRGB`_ is not an accepted value.
    * 
    * `GL_INVALID_VALUE` is generated by `glBlendFuncSeparatei` if _`buf`_ is greater than or equal to the value of `GL_MAX_DRAW_BUFFERS`.
    * 
    * Associated Gets
    * ---------------
    * 
    * [glGet][de.dasbabypixel.gamelauncher.gles.es20.glGetBooleanv.glGetBooleanv] with argument `GL_BLEND_SRC_RGB`
    * 
    * [glGet][de.dasbabypixel.gamelauncher.gles.es20.glGetBooleanv.glGetBooleanv] with argument `GL_BLEND_SRC_ALPHA`
    * 
    * [glGet][de.dasbabypixel.gamelauncher.gles.es20.glGetBooleanv.glGetBooleanv] with argument `GL_BLEND_DST_RGB`
    * 
    * [glGet][de.dasbabypixel.gamelauncher.gles.es20.glGetBooleanv.glGetBooleanv] with argument `GL_BLEND_DST_ALPHA`
    * 
    ...
    * --------
    * 
    * [glBlendColor][de.dasbabypixel.gamelauncher.gles.es20.glBlendColor.glBlendColor], [glBlendFunc][de.dasbabypixel.gamelauncher.gles.es20.glBlendFunc.glBlendFunc], [glBlendEquation][de.dasbabypixel.gamelauncher.gles.es20.glBlendEquation.glBlendEquation], [glBlendEquationSeparate][de.dasbabypixel.gamelauncher.gles.es20.glBlendEquationSeparate.glBlendEquationSeparate], [glClear][de.dasbabypixel.gamelauncher.gles.es20.glClear.glClear], [glDrawBuffers][de.dasbabypixel.gamelauncher.gles.es30.glDrawBuffers.glDrawBuffers], [glEnable][de.dasbabypixel.gamelauncher.gles.es20.glEnable.glEnable],
    * 
    * Copyright
    * ---------
    * 
    ...
    * 
    * @see de.dasbabypixel.gamelauncher.gles.es20.glBlendFuncSeparate.glBlendFuncSeparate
    * @see de.dasbabypixel.gamelauncher.gles.es32.glBlendFuncSeparatei.glBlendFuncSeparatei
    */
    fun glBlendFuncSeparatei(buf: UInt, srcRGB: Int, dstRGB: Int, srcAlpha: Int, dstAlpha: Int)
}