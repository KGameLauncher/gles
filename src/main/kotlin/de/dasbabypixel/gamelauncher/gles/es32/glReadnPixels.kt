...
interface glReadnPixels {
    ...
    */
    fun glReadnPixels(x: Int, y: Int, width: UInt, height: UInt, format: Int, type: Int, bufSize: UInt, data: de.dasbabypixel.gamelauncher.buffers.Buffer)
}