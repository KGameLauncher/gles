...
interface glUniformMatrix3x4fv {
    /**
    * Name
    * ----
    * 
    ...
    */
    fun glUniformMatrix3x4fv(location: Int, count: UInt, transpose: Boolean, value: de.dasbabypixel.gamelauncher.buffers.FloatBufferRO)
}