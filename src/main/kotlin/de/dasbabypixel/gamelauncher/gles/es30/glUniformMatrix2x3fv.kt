...
interface glUniformMatrix2x3fv {
    /**
    * Name
    * ----
    * 
    ...
    */
    fun glUniformMatrix2x3fv(location: Int, count: UInt, transpose: Boolean, value: de.dasbabypixel.gamelauncher.buffers.FloatBufferRO)
}