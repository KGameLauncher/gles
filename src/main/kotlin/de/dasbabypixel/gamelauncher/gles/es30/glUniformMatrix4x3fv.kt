...
interface glUniformMatrix4x3fv {
    /**
    * Name
    * ----
    * 
    ...
    */
    fun glUniformMatrix4x3fv(location: Int, count: UInt, transpose: Boolean, value: de.dasbabypixel.gamelauncher.buffers.FloatBufferRO)
}