...
interface glUniformMatrix3x2fv {
    /**
    * Name
    * ----
    * 
    ...
    */
    fun glUniformMatrix3x2fv(location: Int, count: UInt, transpose: Boolean, value: de.dasbabypixel.gamelauncher.buffers.FloatBufferRO)
}