...
interface glUniformMatrix2x4fv {
    /**
    * Name
    * ----
    * 
    ...
    */
    fun glUniformMatrix2x4fv(location: Int, count: UInt, transpose: Boolean, value: de.dasbabypixel.gamelauncher.buffers.FloatBufferRO)
}